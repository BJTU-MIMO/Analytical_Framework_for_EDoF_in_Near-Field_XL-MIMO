function G = functionDyadicGreen(rr,rt,wavenumber) 

%%=============================================================
%The file is used to generate dyadic Green's function between particular 
% transmitting/receiving points (full polarization) of the paper:
%
...
G = G1*I*G_Scalar + G2*(ar*ar')*G_Scalar; %Generate the dyadic Green's function channel
